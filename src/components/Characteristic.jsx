	...
	<section className='w-full bg-white pb-52 pt-10 md:pb-80 md:pt-16 overflow-x-hidden'>
		...
		<div
			...
			<div className='flex items-center gap-3 md:gap-5 mt-2 mb-6 md:mb-0'>
				<img src={starIcon} alt='star' className='w-7 h-7 md:w-[74px] md:h-[74px]' />
				<span className='font-bold text-[1.7rem] md:text-3xl'>5.0</span>
				<img src={nodejsIcon} alt='Node.js' className='w-10 h-10 md:w-12 md:h-12' />
			</div>
		</div>
		...
		<div
			...
			<div>
				...
				<div
					...
					data-aos-duration='1000'
					data-aos-delay='350'>
					<img src={chip1} alt='Chip 1' className='rounded-[22px] md:rounded-[28px] object-cover w-full aspect-square shadow' />
					<img src={chip2} alt='Chip 2' className='rounded-[22px] md:rounded-[28px] object-cover w-full aspect-square shadow' />
					<img
						src={serverhall}
						alt='Server Hall'
						className='rounded-[22px] md:rounded-[28px] object-cover w-full aspect-square shadow'
			...
			<div
				...
				<div className='mb-10 md:mb-12'>
					<div className='font-bold uppercase text-black tracking-[0.07em] text-lg md:text-xl mb-2 md:mb-6'>CLUSTER</div>
					<div className='text-[#4E4E4E] text-sm md:text-base tracking-[0.03em] mb-1 md:mb-5'>HIGH-SPEED</div>
					<div
				...
				<ul className='space-y-5 md:space-y-6'>
					<li className='flex items-center gap-3 text-black text-lg md:text-xl font-normal'>
						...
						<span>
							<span className='font-bold'>CPU</span> Power <span className='font-bold'>128-Core Gold / Platinum</span>
					...
					<li className='flex items-center gap-3 text-black text-lg md:text-xl font-bold'>
						...
						<span>
							...
							<span className='font-normal text-black ml-2'>Registered RAM +</span>
						</span>
					</li>
					<li className='flex items-center gap-3 text-black text-lg md:text-xl font-bold'>
						<span className='text-[1.45rem] md:text-2xl -ml-1'>☁️</span>
