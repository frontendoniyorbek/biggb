        ...
        '>
          ...
          '
              ...
              '
							...
							<span className='font-bold font-syne text-[18px] sm:text-[20px] mb-1'>{ext}</span>
							<span className='text-gray-500 text-[13px] sm:text-[14px]'>Starting price</span>
							<span className='text-gray-500 text-[14px] sm:text-[15px] font-medium'>$13.34/Yearly</span>
						</div>
					))}
				</div>
			</div>
