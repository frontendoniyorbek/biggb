...
export default function ServerFeatures() {
	...
	return (
        ...
        '
					data-aos='zoom-in-up'>
					{/* CPU */}
					<div className='col-span-1 flex flex-col xl:gap-6 md:gap-4 gap-3' data-aos='fade-up' data-aos-delay='100'>
						<span
							className='
              font-syne
              font-extrabold
            ...
            '>
              ...
              '>
					...
					{/* RAM */}
					<div className='col-span-1 flex flex-col xl:gap-6 md:gap-4 gap-3' data-aos='fade-up' data-aos-delay='200'>
						<span
							className='
              font-syne
              font-extrabold
            ...
            '>
              ...
              '>
					...
					{/* NVME */}
					<div className='col-span-1 flex flex-col xl:gap-6 md:gap-4 gap-3' data-aos='fade-up' data-aos-delay='300'>
						<span
							className='
              font-syne
              font-extrabold
            ...
            '>
              ...
              '>
					...
					{/* GPU */}
					<div className='col-span-1 flex flex-col xl:gap-6 md:gap-4 gap-3' data-aos='fade-up' data-aos-delay='400'>
						<span
							className='
              font-syne
              font-extrabold
            ...
            '>
              ...
              '>
					...
					<div className='col-span-1 flex flex-col xl:gap-6 md:gap-4 gap-3' data-aos='fade-up' data-aos-delay='600'>
						<span
							className='
              font-syne
              font-extrabold
            ...
            '>
					...
					<div className='col-span-1 flex flex-col xl:gap-6 md:gap-4 gap-3' data-aos='fade-up' data-aos-delay='700'>
						<span
							className='
                font-bold
                uppercase
