	...
	return (
		<section className='mt-20 px-4 sm:px-6 lg:px-16'>
			<div
				...
				data-aos='fade-up'>
				<div>
					<h5 className='font-bold uppercase text-xs tracking-widest mb-1'>CONNECT SOCET BIG DATA</h5>
					<div className='text-3xl sm:text-4xl md:text-5xl font-black mb-2'>11 278 620</div>
